...
$(name).$(extension): $(name).c $(cutest) $(function_files) $(test_runner_name).c $(bench_runner_name)/$(bench_runner_name).c
	$(compiler) $(runtime_sanitizers) -o $(name).$(extension) $(name).c $(cutest) $(function_files) $(test_runner_name).c $(bench_runner_name)/$(bench_runner_name).c -lm
